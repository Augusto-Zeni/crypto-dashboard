...
>(({ className, ...props }, ref) => (
  <main
    ...
    className={cn(
      ...
      'md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:me-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow',
